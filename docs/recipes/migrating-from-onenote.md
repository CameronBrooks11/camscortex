...
4. Whatever you choose, you will need to do the following:
   ...
   2. Once cloned, navigate to the repo folder. In VS Code, use File -> Add Folder to Workspace, right click on the folder in the left side bar and click [Open In Integrated Terminal](../../assets/images/foam-docs/migrating-one-note.png).
