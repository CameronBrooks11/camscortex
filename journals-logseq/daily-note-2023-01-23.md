- CC/CV refers to constant current/constant voltage 
- [[SRC module]] are basically [[Semiconductor]], or Silicon, Controlled Rectifiers in a modular package. SCR Modules are used to control and rectify current in only one direction. When a current/voltage pulse is applied to the gate of the SCR, it triggers on and starts to conduct. #
